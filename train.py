...
# Feature Definitions for Claude:
# sp_fip_DIFF: (Away Pitcher FIP - Home Pitcher FIP). Positive = Home Advantage.
# market_logit: Log-odds of the closing market price. Use for Hubacek decorrelation.
# line_move_delta: (Closing Prob - Opening Prob). Positive = Sharp money moved toward Home.
...
desc = f"run24 W={BEST_W} momentum_W={MOMENTUM_W} threshold={CONFIDENCE_THRESHOLD} anchor={MARKET_ANCHOR_LAMBDA} feat_neutralization"
